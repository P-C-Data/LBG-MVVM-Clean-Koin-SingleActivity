package com.clean.mvvmLgb.data.database;
...
import com.clean.mvvmLgb.data.database.dao.FavouriteDao;
import com.clean.mvvmLgb.data.database.dao.FavouriteDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoFavouriteDetails.equals(_existingFavouriteDetails)) {
          return new RoomOpenHelper.ValidationResult(false, "favourite_details(com.clean.mvvmLgb.data.database.entities.FavImageEntity).\n"
